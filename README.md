...
- **Windows telemetry blocking** at network level
- **Telegram** routing for voice/video calls
...
| Routing rules | [`configs/v2rayn/xray/routing-rules.json`](configs/v2rayn/xray/routing-rules.json) | Routing Setting → Import Rules From Clipboard |
